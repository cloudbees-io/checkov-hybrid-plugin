...
Use this action to scan infrastructure configurations with the open-source scanner Checkov or use it as a Software Composition Analysis (SCA) scanner.
...
Access the output values in downstream steps and jobs using the `outputs` xref:dsl-syntax:contexts.adoc[context].
